...
namespace xnaplatformer
{
    class Lvl6 : GameScreen
    {
        ...
        public override void LoadContent(ContentManager content, InputManager input)
        {
            ...
            map = new Map();
            map.LoadContent(content, map, "Map6");
            player.LoadContent("Player", content, "Load/Player/Level6.gth", "", input);
            enemies.LoadContent("Enemy", content, "Load/Enemies/Level6.gth", "Level6", input);
            p = new Player();
            p.First = false;
            p.Second = false;
            p.Third = false;
        ...
        {
            music = content.Load<Song>("Music/12 - Gytreg");
