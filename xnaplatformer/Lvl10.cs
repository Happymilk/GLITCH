...
namespace xnaplatformer
{
    class Lvl10 : GameScreen
    {
        ...
        public override void LoadContent(ContentManager content, InputManager input)
        {
            ...
            map = new Map();
            map.LoadContent(content, map, "Map10");
            player.LoadContent("Player", content, "Load/Player/Level10.gth", "", input);
            enemies.LoadContent("Enemy", content, "Load/Enemies/Level10.gth", "Level10", input);
            p = new Player();
            p.First = false;
            p.Second = false;
            p.Third = false;
        ...
        {
            music = content.Load<Song>("Music/17 - Mixture");
