...
namespace xnaplatformer
{
    class Lvl9 : GameScreen
    {
        ...
        public override void LoadContent(ContentManager content, InputManager input)
        {
            ...
            map = new Map();
            map.LoadContent(content, map, "Map9");
            player.LoadContent("Player", content, "Load/Player/Level9.gth", "", input);
            enemies.LoadContent("Enemy", content, "Load/Enemies/Level9.gth", "Level9", input);
            p = new Player();
            p.First = false;
            p.Second = false;
            p.Third = false;
        ...
        {
            music = content.Load<Song>("Music/16 - Grumpy");
