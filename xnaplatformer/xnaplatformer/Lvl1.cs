...
namespace xnaplatformer
{
    class Lvl1 : GameScreen
    {
        ...
        public override void LoadContent(ContentManager content, InputManager input)
        {
            ...
            player.LoadContent("Player", content, "Load/Player/Level1.gth", "", input);
            enemies.LoadContent("Enemy", content, "Load/Enemies/Level1.gth", "Level1", input);
            p = new Player();
            p.First = true;
            p.Second = false;
            p.Third = false;
        ...
        {
            music = content.Load<Song>("Music/02 - Nature");
