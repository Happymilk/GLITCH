...
namespace xnaplatformer
{
    class Lvl5 : GameScreen
    {
        ...
        public override void LoadContent(ContentManager content, InputManager input)
        {
            ...
            map = new Map();
            map.LoadContent(content, map, "Map5");
            player.LoadContent("Player", content, "Load/Player/Level5.gth", "", input);
            enemies.LoadContent("Enemy", content, "Load/Enemies/Level5.gth", "Level5", input);
            p = new Player();
            p.First = false;
            p.Second = false;
            p.Third = false;
        ...
        {
            music = content.Load<Song>("Music/10 - Abasement");
