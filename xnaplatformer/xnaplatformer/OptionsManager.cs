...
namespace xnaplatformer
{
    public class OptionsManager
    {
        ...
        Game1 g;
        MenuManager mm;
        SoundEffect up, down, select, back;
        ...
        public void LoadContent(ContentManager content, string id)
        {
            ...
            fileManager.LoadContent("Load/Options.gth", attributes, contents, id);
        ...
        public void Update(GameTime gameTime, InputManager inputManager)
        {
            ...
            else
            {
                ...
                if (axis == 1)
                {
                    if (inputManager.ButPressed(Buttons.DPadRight, Buttons.LeftThumbstickRight))
                    {
                        itemNumber++;
                        if (itemNumber <= 23)
                            down.Play();
                ...
                {
                    if (inputManager.ButPressed(Buttons.DPadDown, Buttons.LeftThumbstickDown))
                    {
                        itemNumber++;
                        if (itemNumber <= 23)
                            down.Play();
                ...
                if (inputManager.ButPressed(Buttons.A, Buttons.Start, Buttons.LeftStick))
                {
                    if (linkType[itemNumber] == "Screen")
                    {
                        select.Play();
