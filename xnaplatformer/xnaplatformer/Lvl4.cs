...
namespace xnaplatformer
{
    class Lvl4 : GameScreen
    {
        ...
        public override void LoadContent(ContentManager content, InputManager input)
        {
            ...
            map = new Map();
            map.LoadContent(content, map, "Map4");
            player.LoadContent("Player", content, "Load/Player/Level4.gth", "", input);
            enemies.LoadContent("Enemy", content, "Load/Enemies/Level4.gth", "Level4", input);
            p = new Player();
            p.First = false;
            p.Second = false;
            p.Third = false;
        ...
        {
            music = content.Load<Song>("Music/08 - Night");
