...
namespace xnaplatformer
{
    public class MenuManager
    {
        ...
        string align;
        Song music;
        public SoundEffect up, down, select, back;
        public Boolean iWantMusic = true;
        Game1 g;
        ...
        public void LoadContent(ContentManager content, string id)
        {
            ...
            fileManager.LoadContent("Load/Menu.gth", attributes, contents, id);
        ...
        public void Update(GameTime gameTime, InputManager inputManager, SoundEffect up, SoundEffect down)
        {
            if (g.controlSet != "3")
            {
                ...
                {
                    back.Play();
                    Type newClass = Type.GetType("xnaplatformer.ExitScreen");
            ...
            else
            {
                ...
                if (axis == 1)
                {
                    if (inputManager.ButPressed(Buttons.LeftThumbstickRight, Buttons.DPadRight))
                    {
                        itemNumber++;
                        if (itemNumber >= 0)
                            up.Play();
                    }
                    else if (inputManager.ButPressed(Buttons.LeftThumbstickLeft, Buttons.DPadLeft))
                    {
                        itemNumber--;
                        if (itemNumber <= 4)
                            down.Play();
                ...
                {
                    if (inputManager.ButPressed(Buttons.LeftThumbstickDown, Buttons.DPadDown))
                    {
                        itemNumber++;
                        if (itemNumber <= 4)
                            down.Play();
                    }
                    else if (inputManager.ButPressed(Buttons.LeftThumbstickUp, Buttons.DPadUp))
                    {
                        itemNumber--;
                        if (itemNumber >= 0)
                            up.Play();
                ...
                if (inputManager.ButPressed(Buttons.Start, Buttons.A, Buttons.LeftStick))
                {
                    if (linkType[itemNumber] == "Screen")
                    {
                        if (itemNumber == 0)
        ...
        {
            music = content.Load<Song>("Music/19 - Title");
            if (iWantMusic)
            {
