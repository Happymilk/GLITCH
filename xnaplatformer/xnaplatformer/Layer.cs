...
namespace xnaplatformer
{
    public class Layer
    {
        ...
        public void LoadContent(Map map, string layerID)
        {
            ...
            content = new ContentManager(ScreenManager.Instance.Content.ServiceProvider, "Data");
            fileManager.LoadContent("Load/Maps/" + map.ID + ".gth", attributes, contents, layerID);
            int indexY = 0;
