...
namespace xnaplatformer
{
    class Lvl8 : GameScreen
    {
        ...
        public override void LoadContent(ContentManager content, InputManager input)
        {
            ...
            map = new Map();
            map.LoadContent(content, map, "Map8");
            player.LoadContent("Player", content, "Load/Player/Level8.gth", "", input);
            enemies.LoadContent("Enemy", content, "Load/Enemies/Level8.gth", "Level8", input);
            p = new Player();
            p.First = false;
            p.Second = false;
            p.Third = false;
        ...
        {
            music = content.Load<Song>("Music/15 - Slowmotion");
