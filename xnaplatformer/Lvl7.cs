...
namespace xnaplatformer
{
    class Lvl7 : GameScreen
    {
        ...
        public override void LoadContent(ContentManager content, InputManager input)
        {
            ...
            map = new Map();
            map.LoadContent(content, map, "Map7");
            player.LoadContent("Player", content, "Load/Player/Level7.gth", "", input);
            enemies.LoadContent("Enemy", content, "Load/Enemies/Level7.gth", "Level7", input);
            p = new Player();
            p.First = false;
            p.Second = false;
            p.Third = false;
        ...
        {
            music = content.Load<Song>("Music/14 - Siventic");
